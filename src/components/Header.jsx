    ...
    >
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          {/* Select Country, State, District, Area */}
          <Box
            sx={{
              flexGrow: 1,
          ...
          >
            ...
            >
              <MenuItem onClick={handleCloseDistrictMenu}>District 1</MenuItem>
              <MenuItem onClick={handleCloseDistrictMenu}>District 2</MenuItem>
              <MenuItem onClick={handleCloseDistrictMenu}>District 3</MenuItem>
            </Menu>
